...
2. You don't want AI to push code to production without human oversight. It can take hours or days for a human to review the AI response, so the workflow needs to be idle.
